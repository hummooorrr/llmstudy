...
/** 检索结果重排序工具类：提供 RRF 融合和智谱 Rerank 两种重排算法 */
@Slf4j
public class RerankUtil {
     ...
     * 使用智谱 rerank 重排序
     */
    public static List<String> rerankFusion(List<Document> vectorDocs, List<EsDocumentChunk> keywordDocs, String query, int topK, String apiKey) throws Exception {
